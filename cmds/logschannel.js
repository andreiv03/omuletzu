...
module.exports = {
  name: 'logschannel',
  aliases: ['logsch'],
  description: 'Setează canalul unde să fie afișate toate sanctiunile (ban, unban, kick, warn și mute).\nAtentie, nu poti folosi nicio comandă de moderare înainte să setezi canalul!',
  color: '#f55656',
  usage: '<canal>',
