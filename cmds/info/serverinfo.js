...
module.exports = {
  ...
  execute(message) {
    ...
    const infoEmbed = new Discord.MessageEmbed()
      ...
      .addField('Activitatea membrilor:', [
      ...
      .addField('Alte informatii:', [
        `**Numărul membrilor:** ${message.guild.memberCount - members.filter(member => member.user.bot).size}`,
        `**Numărul botilor:** ${members.filter(member => member.user.bot).size}`,
