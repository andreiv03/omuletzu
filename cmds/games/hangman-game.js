...
module.exports = {
  ...
  async execute(message) {
    ...
    const words = ['camion', 'animal', 'robot', 'balaur', 'elicopter', 'maxim', 'tractor', 'calculator', 'chimie', 'dinozaur', 'enciclopedie', 'telefon', 'calorifer', 'vampir', 'negru', 'albastru', 'praf', 'vis', 'amintire', 'blog', 'fotografie', 'ochelari', 'trecut', 'durere', 'monument', 'portocaliu', 'sentiment', 'sinucidere', 'suflet', 'aglomerat', 'restaurant'];
