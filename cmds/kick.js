...
module.exports = {
  ...
  async execute(message, args) {
    if (!message.member.hasPermission('KICK_MEMBERS')) return message.reply('nu ai permisiunile necesare pentru a folosi această comandă!');
    ...
    member.kick().then(() => {
      ...
      if (member.user.displayAvatarURL()) 
        kickEmbed.setThumbnail(member.user.displayAvatarURL({ dynamic: true }));
